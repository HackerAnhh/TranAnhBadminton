...
namespace TAB.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,Username,Password,Email,FullName,Phone,CreateDate,LastLogin,RoleId,IsActived,CartId,Randomkey")] 
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Username,Password,Email,FullName,Phone,CreateDate,LastLogin,RoleId,IsActived,CartId,Randomkey")] 
        Models.Account account)
        {

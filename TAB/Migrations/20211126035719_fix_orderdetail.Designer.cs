...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TAB.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("TAB.Models.Attribute", b =>
                {
            ...
            modelBuilder.Entity("TAB.Models.AttributePrice", b =>
                {
            ...
            modelBuilder.Entity("TAB.Models.Brand", b =>
                {
            ...
            modelBuilder.Entity("TAB.Models.Cart", b =>
                {
            ...
            modelBuilder.Entity("TAB.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("TAB.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("TAB.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("TAB.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("TAB.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TAB.Models.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TAB.Models.Shipper", b =>
                {
            ...
            modelBuilder.Entity("TAB.Models.TransactStatus", b =>
                {
                    b.Property<int>("TransactionStatusId")
                        .HasColumnType("int")
                        .HasColumnName("TransactionStatusID");
            ...
            modelBuilder.Entity("TAB.ViewModel.LoginViewModel", b =>
                {
                    b.Property<string>("UserName")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("TAB.ViewModel.RegisterViewModel", b =>
                {
                    b.Property<int>("CustommerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TAB.Models.Order", b =>
                {
                    b.HasOne("TAB.Models.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_Order_Customers");

                    b.HasOne("TAB.Models.TransactStatus", "TransactionStatus")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("TAB.Models.OrderDetail", b =>
                {
                    b.HasOne("TAB.Models.Order", "Order")
            ...
            modelBuilder.Entity("TAB.Models.Product", b =>
                {
                    b.HasOne("TAB.Models.Brand", "Brand")
                        .WithMany("Products")
                        .HasForeignKey("BrandId")
                        .HasConstraintName("FK_Product_Brand");

                    b.HasOne("TAB.Models.Category", "Cate")
                        .WithMany("Products")
